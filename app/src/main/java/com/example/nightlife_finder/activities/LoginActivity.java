    ...
    private void setupListeners() {
        ...
        ivTogglePassword.setOnClickListener(v -> {
            ...
            if (isPasswordVisible) {
                etLoginPassword.setInputType(android.text.InputType.TYPE_CLASS_TEXT | android.text.InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                ivTogglePassword.setAlpha(1.0f);
            } else {
                etLoginPassword.setInputType(android.text.InputType.TYPE_CLASS_TEXT | android.text.InputType.TYPE_TEXT_VARIATION_PASSWORD);
